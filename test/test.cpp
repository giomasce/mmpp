...
void test_wffs_trivial() {
    ...
    //auto &lib = data.lib;
    auto &tb = data.tb;
    vector< pwff > wffs = { /*pwff(True::create()), pwff(False::create()), pwff(Not::create(pwff(True::create()))), pwff(Not::create(pwff(False::create()))),
                            pwff(Var::create("ph")), pwff(Not::create(pwff(Var::create("ph")))),
                            pwff(Var::create("ps")), pwff(Not::create(pwff(Var::create("ps")))),
                            pwff(Imp::create(pwff(True::create()), pwff(True::create()))),
                            pwff(Imp::create(pwff(True::create()), pwff(False::create()))),
                            pwff(Imp::create(pwff(False::create()), pwff(True::create()))),
                            pwff(Imp::create(pwff(False::create()), pwff(False::create()))),
                            pwff(Biimp::create(pwff(True::create()), pwff(True::create()))),
                            pwff(Biimp::create(pwff(True::create()), pwff(False::create()))),
                            pwff(Biimp::create(pwff(False::create()), pwff(True::create()))),
                            pwff(Biimp::create(pwff(False::create()), pwff(False::create()))),
                            pwff(And::create(pwff(True::create()), pwff(True::create()))),
                            pwff(And::create(pwff(True::create()), pwff(False::create()))),
                            pwff(And::create(pwff(False::create()), pwff(True::create()))),
                            pwff(And::create(pwff(False::create()), pwff(False::create()))),*/
                            pwff(And3::create(pwff(True::create()), pwff(True::create()), pwff(True::create()))),
                            pwff(And3::create(pwff(True::create()), pwff(False::create()), pwff(True::create()))),
                            pwff(And3::create(pwff(False::create()), pwff(True::create()), pwff(True::create()))),
                            pwff(And3::create(pwff(False::create()), pwff(False::create()), pwff(True::create()))),
                            pwff(And3::create(pwff(True::create()), pwff(True::create()), pwff(False::create()))),
                            pwff(And3::create(pwff(True::create()), pwff(False::create()), pwff(False::create()))),
                            pwff(And3::create(pwff(False::create()), pwff(True::create()), pwff(False::create()))),
                            pwff(And3::create(pwff(False::create()), pwff(False::create()), pwff(False::create()))),
                            pwff(Or::create(pwff(True::create()), pwff(True::create()))),
                            pwff(Or::create(pwff(True::create()), pwff(False::create()))),
                            pwff(Or::create(pwff(False::create()), pwff(True::create()))),
                            pwff(Or::create(pwff(False::create()), pwff(False::create()))),
                            pwff(Nand::create(pwff(True::create()), pwff(True::create()))),
                            pwff(Nand::create(pwff(True::create()), pwff(False::create()))),
                            pwff(Nand::create(pwff(False::create()), pwff(True::create()))),
                            pwff(Nand::create(pwff(False::create()), pwff(False::create()))),
                            pwff(Xor::create(pwff(True::create()), pwff(True::create()))),
                            pwff(Xor::create(pwff(True::create()), pwff(False::create()))),
                            pwff(Xor::create(pwff(False::create()), pwff(True::create()))),
                            pwff(Xor::create(pwff(False::create()), pwff(False::create()))),
                            pwff(Imp::create(pwff(Var::create("ph")), pwff(Var::create("ps")))),
                            pwff(And::create(pwff(Var::create("ph")), pwff(Var::create("ps")))),
                            pwff(And::create(pwff(True::create()), pwff(And::create(pwff(Var::create("ph")), pwff(False::create()))))),
                            pwff(And::create(pwff(False::create()), pwff(And::create(pwff(True::create()), pwff(True::create()))))),
                          };
...
void test_wffs_advanced() {
    ...
    auto &tb = data.tb;
    vector< pwff > wffs = { pwff(True::create()), pwff(False::create()), pwff(Not::create(pwff(True::create()))), pwff(Not::create(pwff(False::create()))),
                             pwff(Imp::create(pwff(Var::create("ph")), pwff(Var::create("ph")))),
                             pwff(Or3::create(pwff(Var::create("ph")), pwff(True::create()), pwff(False::create()))),
                             pwff(Imp::create(pwff(Var::create("ph")), pwff(And3::create(pwff(Var::create("ph")), pwff(True::create()), pwff(Var::create("ph")))))),
                             pwff(Biimp::create(pwff(Nand::create(pwff(Var::create("ph")), pwff(Nand::create(pwff(Var::create("ch")), pwff(Var::create("ps")))))),
                                            pwff(Imp::create(pwff(Var::create("ph")), pwff(And::create(pwff(Var::create("ch")), pwff(Var::create("ps")))))))),
                           };
